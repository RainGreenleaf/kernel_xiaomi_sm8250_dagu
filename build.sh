...
TOOLCHAIN_PATH=/home/bai/toolchains/clang-r487747c/bin/
aarch64=/home/bai/toolchains/clang18/bin/
...
export PATH="$TOOLCHAIN_PATH:$aarch64:$PATH"
...
# echo "Clone AnyKernel3 for packing kernel (repo: https://github.com/RainGreenleaf/AnyKernel3)"
# git clone https://github.com/RainGreenleaf/AnyKernel3 -b kona --single-branch --depth=1 anykernel
...
# make $MAKE_ARGS -Wno-unused-function -j$(nproc)
make $MAKE_ARGS -w -j$(nproc)
