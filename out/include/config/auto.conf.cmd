...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/home/bai/toolchains/clang18/bin//aarch64-linux-gnu- --gcc-toolchain=/home/bai/toolchains/clang18 -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
